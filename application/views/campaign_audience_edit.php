<div class="pageArea">
  ...
  <div class="pageTabs mt-1 extrawWide">
    <ul>
      ...
      else echo base_url('create-targetAudience/'.$brand_id.'/'.$campaign_id);?>"  class="<?php if($this->uri->segment(1)=='edit-targetAudience') echo "active";?>">Target Audience</a></li>
  ...
  <div class="createInfo">
    ...
    echo form_open('admin/targetAudience/editAudience', $attributes);?>
    <input type="hidden" name="brand_id" value="<?php echo $brand_id;?>">
    <input type="hidden" name="campaign_id" value="<?php echo $campaign_id;?>">
    <input type="hidden" name="id" value="<?php echo $audienceData->id;?>">
    <div class="pt-2 pb-2">
            ...
            <ul>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="gender[0]" value="1" class="custom-control-input" id="g-01" <?php if(in_array('1', explode(',', $audienceData->gender))) echo "checked"; ?> >
                  <label class="custom-control-label" for="g-01">Male</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="gender[1]" value="2" class="custom-control-input" id="g-02" <?php if(in_array('2', explode(',', $audienceData->gender))) echo "checked"; ?> >
        ...
        <div class="row">
          <div class="col-12 audienceView">
            ...
            <ul>
              ...
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="age[<?php echo  $count;?>]" value="<?php echo $value->id;?>" class="custom-control-input" id="age-<?php echo $count;?>" <?php if(in_array($value->id, explode(',', $audienceData->age))) echo "checked"; ?> >
      ...
      <div class="p-2 pl-4">
        <div class="row">
          <div class="col-12 audienceView">
            ...
            <div class="row">
            <?php if($inetrestMaster) {  //print_r($inetrestMaster);die;
              $outercnt=0;
                  ...
                  <ul>
                    ...
                    $cnt=0;
                      foreach ($inetrestOption[$key] as  $values) {  ?>
                        <li>
                          <div class="custom-control custom-checkbox  font-weight-bold">
                            <input type="checkbox" name="interest_option_<?php echo $value->id;?>[<?php echo $cnt;?>]" value="<?php echo $values->id;?>" class="custom-control-input" id="f-<?php echo $outercnt.$cnt;?>" <?php if(in_array($values->id, explode(',', $audienceData->interests))) echo "checked"; ?> >
                              <?php if(in_array($values->id, explode(',', $audienceData->interests))) { ?>
      ...
      <?php if($campData){
        ...
        <div class="row pt-2 camDiv">
          <input type="hidden" name="camp_behaviour_id[<?php echo $cnt;?>]" value="<?php echo $camp->id;?>">
          <div class="col-12 col-md-4 placeVaild">
            <select class="form-control" name="camp_id[<?php echo $cnt;?>]" required>
              <option value="">Select Campaign</option>
                <?php foreach ($campData as $value) { ?>
                <option value="<?php echo $value->id;?>" <?php if($value->id==$camp->campaign_id) echo "selected"; ?>><?php echo $value->campaign_name;?> </option>
                <?php //} 
              } ?>
            </select>
          </div>
          ...
          <div class="col-12 audienceView pt-3 pb-0 pl-4 placeVaild">
            ...
            <ul>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="camp_behaviour_<?php echo $cnt;?>[]" value="1" class="custom-control-input" id="a-<?php echo $cnt;?>0" <?php if(in_array('1', explode(',', $camp->camp_behaviour))) echo "checked"; ?> required >
                  <label class="custom-control-label" for="a-<?php echo $cnt;?>0">Added A Review</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="camp_behaviour_<?php echo $cnt;?>[]" value="2" class="custom-control-input" id="a-<?php echo $cnt;?>1" <?php if(in_array('2', explode(',', $camp->camp_behaviour))) echo "checked"; ?>  >
                  <label class="custom-control-label" for="a-<?php echo $cnt;?>1">Did not Add A Review</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="camp_behaviour_<?php echo $cnt;?>[]" value="3" class="custom-control-input" id="a-<?php echo $cnt;?>2" <?php if(in_array('3', explode(',', $camp->camp_behaviour))) echo "checked"; ?>  >
                  <label class="custom-control-label" for="a-<?php echo $cnt;?>2">Did Not Scan QR Code At Vending Machine</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="camp_behaviour_<?php echo $cnt;?>[]" value="4" class="custom-control-input" id="a-<?php echo $cnt;?>3" <?php if(in_array('4', explode(',', $camp->camp_behaviour))) echo "checked"; ?>  >
                  <label class="custom-control-label" for="a-<?php echo $cnt;?>3">Obtained Sample QR Code</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="camp_behaviour_<?php echo $cnt;?>[]" value="5" class="custom-control-input" id="a-<?php echo $cnt;?>4" <?php if(in_array('5', explode(',', $camp->camp_behaviour))) echo "checked"; ?>  >
                  <label class="custom-control-label" for="a-<?php echo $cnt;?>4">Did Not Obtain Sample QR Code</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="camp_behaviour_<?php echo $cnt;?>[]" value="6" class="custom-control-input" id="a-<?php echo $cnt;?>5" <?php if(in_array('6', explode(',', $camp->camp_behaviour))) echo "checked"; ?>  >
                  <label class="custom-control-label" for="a-<?php echo $cnt;?>5">Scanned QR Code At Vending Machine</label>
                </div>
              </li>
            </ul>
          </div>
      ...
      <?php  if($postData){ 
        ...
        <div class="row pt-4 postDiv">
          <div class="col-12 col-md-4 placeVaild" id="postDiv<?php echo $count;?>">
            <div class="postView">
              <input type="hidden" name="post_id[]" value="<?php echo $post->post_id;?>" >
              <input type="hidden" name="post_behaviour_id[<?php echo $count;?>]" value="<?php echo $post->id;?>">
              <div class="postView-img"><?php if($post->banner_type=='1'&& $post->post_banner_url!='' && file_exists('assets/post/banner/'.$post->post_banner_url)) { ?><img src="<?php echo base_url('assets/post/banner/'.$post->post_banner_url);?>" alt="<?php echo $post->post_banner_url;?>"/><?php } ?></div>
          ...
          <div class="col-12 audienceView pt-3 pb-0 pl-4 placeVaild">
            ...
            <ul>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="post_behaviour_<?php echo $count;?>[]" value="1" class="custom-control-input" id="p-<?php echo $count;?>0" <?php if(in_array('1', explode(',', $post->post_behaviour))) echo "checked"; ?> required>
                  <label class="custom-control-label" for="p-<?php echo $count;?>0">Liked A Post</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="post_behaviour_<?php echo $count;?>[]" value="2" class="custom-control-input" id="p-<?php echo $count;?>1" <?php if(in_array('2', explode(',', $post->post_behaviour))) echo "checked"; ?> >
                  <label class="custom-control-label" for="p-<?php echo $count;?>1">Did not Like A Post</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="post_behaviour_<?php echo $count;?>[]" value="3" class="custom-control-input" id="p-<?php echo $count;?>2" <?php if(in_array('3', explode(',', $post->post_behaviour))) echo "checked"; ?> >
                  <label class="custom-control-label" for="p-<?php echo $count;?>2">Obtained Promo Code</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="post_behaviour_<?php echo $count;?>[]" value="4" class="custom-control-input" id="p-<?php echo $count;?>3" <?php if(in_array('4', explode(',', $post->post_behaviour))) echo "checked"; ?> >
                  <label class="custom-control-label" for="p-<?php echo $count;?>3">Commented On A Post</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="post_behaviour_<?php echo $count;?>[]" value="5" class="custom-control-input" id="p-<?php echo $count;?>4" <?php if(in_array('5', explode(',', $post->post_behaviour))) echo "checked"; ?> >
                  <label class="custom-control-label" for="p-<?php echo $count;?>4">Did Not Comment On A Post</label>
                </div>
              </li>
              <li>
                <div class="custom-control custom-checkbox  font-weight-bold">
                  <input type="checkbox" name="post_behaviour_<?php echo $count;?>[]" value="6" class="custom-control-input" id="p-<?php echo $count;?>5" <?php if(in_array('6', explode(',', $post->post_behaviour))) echo "checked"; ?> >
                  <label class="custom-control-label" for="p-<?php echo $count;?>5">Did Not Obtain Promo Code</label>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content ">
          ...
          <div class="modal-body text-center">
            <p>Select atleast one checkbox for campaign</p>
          </div>
 ...
 // FORM SUBMIT
  $("#targetAudience-form").validate({
    ...
    submitHandler: function(e) {
      ...
      $.ajax({  
        type: "POST",  
        url:  "<?php echo base_url(); ?>" + "admin/targetAudience/editAudience",  
        data: user,  
        cache: false,  
  ...
  //var questionId=$(this).closest(".camDiv").find('input').attr('id'); 
   /* if(campId!=undefined){
    ...
    if($('.camDiv:visible').length>1){
      //$(this).closest(".camDiv").find('input:text').val('');   
      $(this).closest(".camDiv").find('select').val('');
      $(this).closest('.camDiv').hide();
    }
  });
$(document).on("click",".removePost",function() {
    if($('.postDiv:visible').length>1){
      //$(this).closest(".postDiv").find('input:text').val(''); 
      $(this).closest(".postDiv").find('input').val(''); 
