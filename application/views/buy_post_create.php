<div class="pageArea">
  <div class="pageHeader clearfix">
    ...
    echo form_open('admin/posts/addBuyPosts', $attributes);?>
      ...
      <!-- <div class="pb-5">
        <div class="row align-items-center ">
           <div class="col-12 col-md-4">
            <input id="startDateInput" type="text" name="start_date" placeholder="
            State date" class="form-control dateIcon" required autocomplete="off" onkeydown="return false;"/>
            </div> 
            <div class="col-12 col-md-5">
              <input id="endDateInput" type="text" name="end_date" placeholder="
            End date" class="form-control dateIcon" required autocomplete="off" onkeydown="return false;"/>
            </div>
          </div>
        </div> -->
        ...
        <div class="row align-items-center ">
           <div class="col-12 col-md-4">
            <input type="text" class="form-control" id="buynowUrlField" placeholder="Buy now url" name="buy_now_url" required />
            </div> 
            <div class="col-12 col-md-5">
  ...
  function submitform(type){
    ...
    message:{
      ...
      submitHandler: function() {
        ...
        $.ajax({  
          type: "POST",  
          url:  "<?php echo base_url(); ?>" + "admin/posts/addBuyPosts",  
          data: user,  
          cache: false,  
