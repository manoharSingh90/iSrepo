<div class="pageArea">
  <div class="pageHeader clearfix">
    <h2 class="float-left pageTitle"><a class="text-white mr-2" onClick="history.back();" value="Back" style="cursor: pointer">Back</a> | <span class="ml-2">Create New Brand</span></h2>
    ...
    echo form_open('admin/brands/addBrands', $attributes);?>
        ...
        <div class="row ">
          <div class="col-12 col-md-3">
            ...
            <div class="col-12 col-md-4">
              ...
              <textarea class="form-control" name="brand_desc" required></textarea>
            </div>
          </div>
        </div>
        <h2>Media</h2>
        ...
        $("#brand-form").validate({
                ...
                submitHandler: function() {
                  ...
                  var user = $('#brand-form').serialize();
                   $.ajax({  
                      type: "POST",  
                      url:  "<?php echo base_url(); ?>" + "admin/brands/addBrands",  
                      data: user,  
                      cache: false,  
