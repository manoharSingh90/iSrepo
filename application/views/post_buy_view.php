<div class="pageArea">
  <div class="pageHeader clearfix">
    <h2 class="float-left pageTitle"><a class="text-white mr-2" href="<?php echo base_url('posts');?>" onClick="history.back();" value="Back" style="cursor: pointer">Back</a> | <span class="ml-2">View Post</span></h2>
      ...
      <div class="pb-2 pt-2">
        <div class="row">
          ...
          <div class="col-12 col-md-3">
            ...
            <input class="form-control" placeholder="Buy now url" value="<?php echo $postDtl[0]->buy_now_url;?>" name="buy_now_url" <?php echo $readonly;?>> 
          </div>
        <?php } ?>
        </div>
